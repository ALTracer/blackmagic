...
static FAR const char *const g_type_check_kinds[] = {"load of", "store to", "reference binding to",
	"member access within", "member call on", "constructor call on", "downcast of", "downcast of"};
...
static void val_to_string(FAR char *str, size_t size, FAR struct type_descriptor *type, FAR void *value)
{
	if (type_is_int(type)) {
...
void __ubsan_handle_alignment_assumption(FAR void *data, uintptr_t ptr, uintptr_t align, uintptr_t offset)
{
